...
public class Goods {
	...
	public Goods(int good_id, int price, int inventory, int pid, int bname, int good_length, int good_width,
			int good_height, int weight, int good_status, String good_name, String sku, String upc, String ena,
			String warranty, String edescription, String aedescription, String good_img, String good_type) {
		super();
		this.good_id = good_id;
		this.price = price;
		this.inventory = inventory;
